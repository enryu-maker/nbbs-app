...
const services = [
  ...
  },
  {
    ...
    audience: 'Sales-driven businesses with field teams and incentive structures.',
    ...
    const ctx = gsap.context(() => {
      ...
      if (sections.length && servicesSectionRef.current) {
        ...
        sections.forEach((section, index) => {
          ...
          timeline.to(section, { yPercent: 0, duration: 1, ease: 'none' }, `service-${index}`);
        });
      }
          ...
          <div className="max-w-320 mx-auto px-5 sm:px-8 md:px-10 lg:px-16 pt-12 sm:pt-14 md:pt-16 lg:pt-20 pb-10 sm:pb-12">
            <div className="max-w-3xl">
              ...
              >
                Business problems.
                <br />
                <span className="text-[#c49b55] italic">Practical solutions.</span>
              </h2>

              <p className="mt-5 sm:mt-7 max-w-2xl text-[14.5px] sm:text-[16px] md:text-[18px] leading-[1.65] sm:leading-[1.7] text-[#4b4b54]">
                We diagnose how your business works today, identify where things break down, and
                build practical systems that help you operate, decide and grow better.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-320 mx-auto px-5 sm:px-8 md:px-16 flex justify-center">
            ...
            >
              ...
              <p
                ...
                "
              >
                A focused 30-minute conversation to understand your current operational friction and
                determine if our ecosystem is the right fit.
              </p>
