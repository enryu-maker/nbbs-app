...
export default function HeroDiagram() {
  ...
  const scribbles = Array.from({ length: 42 }, (_, i) => {
    ...
    const rotation = -22 + Math.sin(angle * 0.21) * 42;
  ...
  return (
    ...
    >
      ...
      <g fill="none" stroke="#172039" strokeWidth="1.25" strokeLinecap="round" opacity="0.9">
        {scribbles.map((s, i) => (
          <ellipse
            key={i}
            cx={s.cx}
      ...
      <g fill="none" stroke="#172039" strokeWidth="1.35" strokeLinecap="round" opacity="0.82">
        <ellipse cx="300" cy="300" rx="74" ry="82" transform="rotate(-18 300 300)" />

        <ellipse cx="300" cy="300" rx="86" ry="68" transform="rotate(27 300 300)" />

        <ellipse cx="300" cy="300" rx="62" ry="92" transform="rotate(55 300 300)" />

        <ellipse cx="300" cy="300" rx="95" ry="57" transform="rotate(-42 300 300)" />

        <ellipse cx="300" cy="300" rx="52" ry="76" transform="rotate(12 300 300)" />
      </g>
      ...
      <g fill="none" stroke="#c9a86a" strokeWidth="1.4" strokeLinecap="square">
        {/* Upper lines */}
      ...
      <g stroke="#c9a86a" strokeWidth="1.5" opacity="0.9">
      ...
      <circle cx="470" cy="95" r="4" fill="#c9a86a" />
    </svg>
  );
}
