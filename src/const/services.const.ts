...
export const defaultServices: ServiceItem[] = [
  {
    ...
    subcategory: 'Most businesses don’t have a growth problem. They have a clarity problem.',
    description:
    ...
    perfectFor: 'MSME owners who want clarity on where their business stands and what to do next.',
    businessProof:
    ...
    // Aliases
    title1: 'Most businesses don’t have a growth problem. They have a clarity problem.',
    problem:
      'The Business Clarity Workshop helps founders step back from daily firefighting, assess where their business truly stands, identify what’s holding it back, and know what to focus on next through our 8-Pillar Business Clarity Diagnostic.',
    ...
    audience: 'MSME owners who want clarity on where their business stands and what to do next.',
    proof:
      'An interactive 3-hour workshop built around practical business frameworks and an 8-Pillar Business Health Diagnostic.',
  },
  {
    ...
    subcategory: 'One focused diagnosis. A clear prescription. Actionable next steps.',
    description:
    ...
    perfectFor: 'MSME founders who need clarity on what’s holding their business back.',
    businessProof: '150+ Business Diagnostics Delivered',
    highlights: [
      {
        title: 'PERFECT FOR',
        description: 'MSME founders who need clarity on what’s holding their business back.',
      },
      {
        title: 'BUSINESS PROOF',
    ...
    // Aliases
    title1: 'One focused diagnosis. A clear prescription. Actionable next steps.',
    problem:
      'In a focused 90-minute Business OPD™, we look beyond the symptoms to understand what’s really happening in your business, where the gaps are, and what deserves your attention first.',
    identity: 'Key Takeaways',
    points: [
    ...
    audience: 'MSME founders who need clarity on what’s holding their business back.',
  ...
  },
  {
    ...
    businessProof: '30% fewer incentive disputes. Save hours on complex incentive calculations.',
    highlights: [
      {
        title: 'PERFECT FOR',
        description: 'Built for founders and growing teams who value transparency',
      },
      {
        title: 'BUSINESS PROOF',
        description: '30% fewer incentive disputes. Save hours on complex incentive calculations.',
      },
    ],
    // Aliases
    title1:
    ...
    proof: '30% fewer incentive disputes. Save hours on complex incentive calculations.',
  },
];
